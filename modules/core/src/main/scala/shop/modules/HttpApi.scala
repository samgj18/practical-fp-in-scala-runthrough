...
import shop.infrastructure.http.routes.auth._
import shop.infrastructure.http.auth.user._
import shop.infrastructure.http.routes._
import shop.infrastructure.http.routes.secured._
import shop.infrastructure.http.routes.admin._
